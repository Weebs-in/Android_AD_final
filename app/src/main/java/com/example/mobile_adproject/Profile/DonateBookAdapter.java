...
public class DonateBookAdapter extends RecyclerView.Adapter<DonateBookAdapter.DonateViewHolder>{
    Context context;
    List<RecommendBook> recommendBookList;//the donate book just the recommmend books, they are all books

    public DonateBookAdapter(Context context, List<RecommendBook> recommendBookList) {
